...
type ToDoListPropsType = {
    ...
    checkBoxOnChange: (elId: number) => void
    filterButton: (buttonName: FilterButtonType) => void
    deleteTask: (elId: number) => void
}
...
export const ToDoList = (props: ToDoListPropsType) => {
    ...
    return (
        <div>
            <h3>{props.title}</h3>
            <div>
                <input type="text" value={inputValue} onChange={onChangeHandler} onKeyPress={onKeyPressHandler}/>
                    ...
                    {props.data.map((el, index) => {
                        ...
                        return (
                            <li key={el.id} value={index + 1}>
                                <input onChange={checkBoxOnChangeHandler} type="checkbox"
                                       checked={el.isDone}/>
                                <input type="button" onClick={deleteTask} value={'x'}/>
                                {el.title}
            ...
            <div>
                <Button buttonTitle={'All'} callBack={() => props.filterButton('All')}/>
                <Button buttonTitle={'Active'} callBack={() => props.filterButton('Active')}/>
                <Button buttonTitle={'Completed'} callBack={() => props.filterButton('Completed')}/>
            </div>
        </div>
    )
}
